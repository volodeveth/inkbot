...
5. **App Store preparation** — готово:
   ...
   - ✅ Screenshot generator page (`/screenshots`) — 5 готових блоків 1600×900px
6. **Наступні кроки**:
   - Відкрити `https://inkbot.app/screenshots` і зробити скріншоти кожного з 5 блоків
...
Тимчасова сторінка для створення App Store скріншотів. 5 блоків 1600×900px:
1. **Dashboard** — "Your AI Writing Command Center"
2. **Generate** — "Generate SEO-Optimized Descriptions in Seconds"
3. **Bulk Generate** — "Process Your Entire Catalog at Once"
4. **Brand Voice** — "Train AI to Match Your Brand Voice"
5. **Billing** — "Start Free, Scale As You Grow"

Кожен блок: ліва панель (лого InkBot + headline + features) + права панель (browser mockup з UI додатку).
Після публікації в App Store цю сторінку можна видалити.
